...
class Server:
    ...
    def get_hyper_index(self, index: int = None, page_size: int = 10) -> Dict:
        """Gets a page from the dataset in a deletion-resilient way.

        Arguments:
            index: The page index, using a deletion-resilient index.
        ...
        # Calculate the page boundaries in the indexed dataset
        page_start = index
